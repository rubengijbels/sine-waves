...
const drawWaves = () => {
  ...
  if (sine2Shape != null) stage.removeChild(sine2Shape)

  if (sineSumShape != null) stage.removeChild(sineSumShape)
...
ticker.run(60, stage, () => {
  ...
  if (dotShape != null) stage.removeChild(dotShape)
